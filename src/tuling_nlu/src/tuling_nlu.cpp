 ...
 * History:
 *   init this file.
 *   增加解析语音控制小车移动和导航的命令词,可以通过中文语音来控制
 *      小车移动和自动导航到目的地。
*/
...
//static string tuling_key="c5f0f3dcca1b4bc9aa1cffa88d7d9250"; //default tuling key
static string tuling_key="0c0259c1ad964c60b21e68d4df692f28";
